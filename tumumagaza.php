...
<body class="body">
  ...
  <div class="arkaplan2">
    ...
    <div class="buttonContainer2">
      ...
      <button class="btnben" type="submit" name="btnmag" onclick="window.location.href = 'tumumagaza.php';">Mağazam</button>
      <button class="arabutton" type="submit" name="btntum" onclick="window.location.href = 'tumutummagaza.php';">Tüm Mağazalar</button>
