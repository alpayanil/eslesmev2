...
echo "<table border='1' >";
echo "<tr>";
echo "<th width='12%'>Item</th>";
echo "<th width='12%'>Ürün Adı</th>";
echo "<th width='12%'>Ekleme Tarihi</th>";
echo "<th width='12%'>Gönderilen</th>";
echo "<th width='12%'>Gönderen</th>";
echo "<th width='12%'>Durum</th>";
echo "<th width='12%'>Ürünü Kaldır</th>";
